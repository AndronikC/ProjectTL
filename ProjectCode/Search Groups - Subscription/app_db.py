...
courses = [
    ...
    # Νέα Μαθήματα
    ("Μηχανική Μάθηση", 1), ("Τεχνητή Νοημοσύνη", 1), ("Κυβερνοασφάλεια", 1),
    ("Επιχειρησιακή Έρευνα", 5), ("Νευροεπιστήμη", 3), ("Κοινωνιολογία", 4),
    ("Οικονομετρία", 5), ("Αστροφυσική", 6), ("Στατιστική Ανάλυση", 7),
    ("Ψηφιακά Κυκλώματα", 2), ("Ανάπτυξη Εφαρμογών", 1), ("Δίκτυα Υπολογιστών", 1),
    ("Διαφορικές Εξισώσεις", 7), ("Βιοηθική", 3), ("Εμπορικό Δίκαιο", 4)
]
...
# Εισαγωγή Ομάδων Μελέτης (διπλάσιες)
groups = [
    # Παλιά
    ...
    # Νέα
    ("Μηχανική Μάθηση - Παπαδόπουλος", 16, 1, 5, 2, "2025-07-05", "12:00", "Υβριδικό"),
    ("ΤΝ - Νικολάου", 17, 3, 6, 1, "2025-07-07", "10:00", "Δια ζώσης"),
    ("Κυβερνοασφάλεια - Γεωργίου", 18, 5, 8, 6, "2025-07-09", "09:00", "Εξ αποστάσεως"),
    ("Επιχειρησιακή Έρευνα - Διαμαντής", 19, 10, 6, 3, "2025-07-10", "13:00", "Υβριδικό"),
    ("Αστροφυσική - Λεωνίδας", 22, 8, 5, 4, "2025-07-12", "15:00", "Δια ζώσης"),
    ("Ψηφιακά Κυκλώματα - Κωνσταντίνου", 25, 2, 6, 2, "2025-07-15", "11:00", "Εξ αποστάσεως"),
    ("Ανάπτυξη Εφαρμογών - Παπαδόπουλος", 26, 1, 4, 1, "2025-07-16", "14:00", "Υβριδικό"),
    ("Οικονομετρία - Μιχαήλ", 21, 6, 5, 2, "2025-07-18", "16:00", "Δια ζώσης"),
    ("Νευροεπιστήμη - Αναστασίου", 20, 4, 5, 3, "2025-07-20", "12:00", "Εξ αποστάσεως"),
    ("Εμπορικό Δίκαιο - Βασιλείου", 30, 9, 6, 3, "2025-07-22", "10:00", "Υβριδικό")
]
cur.executemany("""
...
conn.commit()
conn.close()
print("✅ Βάση και δεδομένα δημιουργήθηκαν επιτυχώς.")
